export default class GamePlay {
  ...
  drawUI() {
    ...
    this.missesEl = this.container.querySelector('[data-id=misses] span'); // элемент промохов
    ...
    for (let i = 0; i < this.boardSize ** 2; i += 1) {
      ...
      cellEl.classList.add('cell'); // добавляем класс для div
  ...
  changeMisses(points) { // изменение кол-ва промохов
